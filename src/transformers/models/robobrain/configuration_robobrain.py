...
class RoboBrainVisionConfig(PretrainedConfig):
...
class RoboBrainTextConfig(PretrainedConfig):
    r"""
    ...
    # Default tensor parallel plan for base model `RoboBrain`
    base_model_tp_plan = {
...
class RoboBrainConfig(PretrainedConfig):
    r"""
    ...
    model_type = "robobrain"
    sub_configs = {"vision_config": RoboBrainVisionConfig, "text_config": RoboBrainTextConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
...
__all__ = ["RoboBrainConfig", "RoboBrainTextConfig"]
